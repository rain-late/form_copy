    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
          ...
          >
            <!-- <el-input
              v-if="activeData.__config__.customtype === 'custom'"
              v-model="activeData.__config__.label"
              :placeholder="activeData.__config__.placeholder"
              @input="changeCustomName"
            />
            ...
            <div v-if="activeData.__config__.customtype === 'custom'">
          ...
          <el-form-item v-if="activeData.__config__.tag === 'custom-address'" label="地址类型">
            {{ activeData.addressType }}
            <el-select v-model="activeData.addressType">
  ...
  methods: {
    ...
    changeRenderKey(val) {
      if (needRerenderList.includes(this.activeData.__config__.tag)) {
        ...
        this.$set(this.activeData.__config__, 'componentName', val)
      }
    }
    // changeCustomName(val) {
    //   this.$set(this.activeData.__config__, 'componentName', val)
    // }
  }
}
